...
namespace GymManagementApi.Data
{
    public class AttendanceRepository
    {
        ...
        #endregion
        #region GetSingleMembersAttendance
        public IEnumerable<AttendanceModel> GetSingleMembersAttendance(int MemberID)
        {
            var attendanceReport = new List<AttendanceModel>();

            using (SqlConnection conn = new SqlConnection(_connectionString))
            {
                SqlCommand cmd = new SqlCommand("PR_GetMemberAttendance", conn)
                {
                    CommandType = System.Data.CommandType.StoredProcedure
                };
        ...
        #endregion
        #region GetSingleTrainersAttendance
        public IEnumerable<AttendanceModel> GetSingleTrainersAttendance(int TrainerID)
        {
            var attendanceReport = new List<AttendanceModel>();

            using (SqlConnection conn = new SqlConnection(_connectionString))
            {
                SqlCommand cmd = new SqlCommand("PR_GetTrainerAttendance", conn)
                {
                    CommandType = System.Data.CommandType.StoredProcedure
                };
                cmd.Parameters.AddWithValue("@TrainerID", TrainerID);
